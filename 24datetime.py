...
"""
2. you can make an object using the datetime class.
    give specific date, and you have a date as an object you can manipulate.

3. bellow are the all formets(parameters) you can use in a strftime() function.
